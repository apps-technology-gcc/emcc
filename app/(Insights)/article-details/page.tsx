      ...
      <Section bgColor="white" className="">
        <div className="grid col-span-11 grid-cols-1 md:grid-cols-11 gap-12">
          ...
          <div className="md:col-span-4 place-content-start justify-start grid grid-cols-1 xs:grid-cols-2 md:grid-cols-1 gap-12">
            <div className="flex flex-col gap-5">
              <Text variant={"card_title_large"}>How Innovation Works</Text>
              <Image src={BookImg} width={370} height={580} alt="article" />
            </div>
            <div className="flex flex-col w-full !pb-5 border-border border-b-[1px] gap-8">
              ...
              <div className="flex flex-col gap-5">
                ...
                <Text variant={"body"}>
                  ...
                  ipsum. Fringilla nisi auctor risus lectus etiam sed ultricies.
                  Pellentesque maecenas ut malesuada bibendum tincidunt sit
                  aliquam. Fringilla nec mattis tortor amet egestas in. Arcu mi
                  elementum vulputate auctor amet proin risus. Velit eu
                  consequat diam pharetra.
                </Text>
              </div>
            </div>
            <ResourcesItem />
