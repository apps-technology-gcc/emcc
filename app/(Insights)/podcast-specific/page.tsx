            ...
            >
              <div className="flex items-start justify-between gap-5">
                <div className="flex flex-auto flex-col gap-5">
                  ...
                  <div className="w-8 h-8 flex items-center justify-center bg-green-300 rounded-full">
                    <Icon name="play_arrow" className="" />
                  </div>
                </div>
                <Icon
                  name="bookmark_add"
                ...
                />
                <Icon name="share" className="text-[24px] text-white" />
              </div>
              ...
              <div className="flex items-center justify-end gap-2.5">
                ...
                <Icon name="graphic_eq" className="text-[20px] text-white" />
              </div>
            </div>
          </div>
