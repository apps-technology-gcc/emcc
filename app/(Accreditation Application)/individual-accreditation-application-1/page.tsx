      ...
      <div className="w-full max-w-[1000px] px-5 md:px-0">
        <div className="flex items-center justify-center flex-col gap-20">
          ...
          <Text variant={"section_title"} className="text-neutral">
            EMCC Global Accreditation Application Form
          </Text> */}
          <PageTitle
          ...
          <div className="flex flex-col gap-8">
            ...
            <div className="flex flex-col gap-5">
              ...
              <BulletText
                texts={[
                  "Lorem ipsum dolor sit amet consectetur.",
                  "Ipsum porttitor faucibus non <u>porta quam.</u> Suspendisse porta scelerisque magna urna urna sem egestas libero etiam.",
