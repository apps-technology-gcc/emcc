...
const SurveySection = () => {
  ...
  return (
    <Section
      bgColor=""
      className="relative bg-[#1C1C1C] lg:h-[560px] flex justify-center"
    >
      <div className="w-full h-full flex items-center">
        <div className="grid h-auto gap-5 md:gap-0 grid-cols-1 sm:grid-cols-2  max-md:flex-col">
          <div className="flex flex-col max-md:ml-0 max-md:w-full">
            <motion.div
              ...
              className=" flex w-auto justify-center min-h-[281px] gap-8 md:gap-12 flex-col self-stretch  my-auto  max-md:-mr-3 max-md:max-w-full"
            >
          ...
          <div className="relative flex md:hidden 2xl:flex w-full h-full">
            ...
            <div className="flex-1 max-h-[400px] overflow-hidden">
              ...
              >
                <Image
                  className=" w-full  flex-auto object-none"
                  alt="SurveyImg"
            ...
            <div className="absolute flex items-center gap-5  right-0 -bottom-5 transform translate-y-[40px]">
              <div
                onClick={() => prevSlide()}
            ...
            <div className="absolute flex items-center gap-5  -left-[48.5px] bottom-0 transform -translate-x-[50px]">
      ...
      <div className="absolute hidden md:block h-[400px] 2xl:hidden  right-0 top-1/2 transform -translate-y-1/2 w-[46.5%]">
